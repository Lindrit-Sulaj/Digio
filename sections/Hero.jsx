    ...
    <section className="hero py-8 lg:px-10 pb-14 lg:pb-24 xl:pb-24">
      <div className="flex flex-col items-center lg:flex-row h-full container mx-auto justify-between gap-y-8">
        <div className="w-full px-4 lg:px-0 lg:w-1/2">
          <h3 className={`mb-3 text-green-700 font-medium ${sourceSans.className} uppercase tracking-wider`}>
            Digio
          </h3>
          ...
          <div className={`inline-flex border-solid border-y-[1px] flex-wrap md:flex-nowrap border-y-neutral-200 gap-6 py-6 mt-8 `}>
