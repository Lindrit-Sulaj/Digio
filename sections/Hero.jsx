    ...
    <section className="hero py-8 lg:px-10 pb-14 lg:pb-24 xl:pb-24">
      <div className="flex flex-col items-center lg:flex-row h-full container mx-auto justify-between gap-y-8">
        <div className="w-full px-4 lg:px-0 lg:w-1/2">
          ...
          <h1 className={`text-3xl md:text-4xl lg:text-6xl max-w-sm md:max-w-none mb-8 ${playfair.className}`}>Maximize Your Online Potential</h1>
          <p className={`${poppins.className} md:text-lg text-neutral-500 max-w-xl`}>We are a leading web development and digital marketing company that helps businesses grow their online presence, by improving their website or digital marketing.</p>
          ...
          <div className={`inline-flex border-solid border-y-[1px] flex-wrap md:flex-nowrap border-y-neutral-200 gap-y-6 md:gap-6 py-6 mt-8 `}>
